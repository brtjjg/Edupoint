...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        /* ============================================================
           RESPONSIVE DESIGN - FITS PHONES, TABLETS AND COMPUTERS
           ============================================================ */
        ...
        .overflow-x{width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}
        table{min-width:600px}

        /* Keep the landing/payment screens centered without making them tiny */
        #landingPage,#paymentPage{width:100%;min-width:0;box-sizing:border-box}
        #landingPage>div,#paymentPage>div{box-sizing:border-box}
        #paymentPage>div{width:100%;max-width:450px !important}

        @media (max-width:900px){
            .container{max-width:100%;padding:12px}
            .header{padding:16px 0}
            .header h1{font-size:1.55em}
            .card,.founder-card{padding:16px}
            .pts-big{font-size:3.2em}
        ...
        @media (max-width:600px){
            ...
            .logo{width:56px;height:56px;border-radius:16px;font-size:27px}
            .header h1{font-size:1.35em;line-height:1.2}
            .card{border-radius:14px;padding:14px;margin-bottom:12px}
            .card h3{font-size:1em;margin-bottom:10px}

            .subj-row{display:grid;grid-template-columns:minmax(0,1fr) 82px;gap:6px}
            select{width:100%;min-width:0;padding:10px 8px;font-size:13px}
            input{padding:10px;font-size:14px}
            .gs{width:auto}

            .btn{padding:13px 14px;font-size:.9em}
            .btn-calc{padding:14px;font-size:1em}

            .result-box{padding:16px}
            .pts-big{font-size:2.7em}
            .ai-card{padding:14px}
            .sec-green,.sec-yellow{padding:9px 10px;font-size:.8em}

            .stats-grid{grid-template-columns:1fr 1fr;gap:6px}
            .stat-card{padding:9px 5px}

            .contact-row{gap:6px}
            .contact-btn{padding:7px 11px;font-size:.75em}
            .social-row{gap:10px}

            .footer{padding:14px 8px;font-size:.68em}
            .wa-float{width:48px;height:48px;right:12px;bottom:14px;font-size:23px}
            .notif{left:10px;right:10px;top:10px;font-size:.8em}

            /* Landing and payment cards */
            #landingPage,#paymentPage{padding:10px !important;align-items:flex-start !important}
            #landingPage>div,#paymentPage>div{max-width:100% !important;border-radius:16px !important;padding:18px !important;margin:0 auto}
            #landingPage>div>span{font-size:3em !important}
            #landingPage h2,#paymentPage h2{font-size:1.25em !important;line-height:1.25}

            #paymentPage .pay-box{padding:13px !important;margin:12px 0 !important}
            #paymentPage .pay-box p{font-size:.9em}
            #paymentPage input,#paymentPage select{font-size:14px !important;min-height:44px}
            #paymentPage button{min-height:44px}
            #paymentPage ul{margin:14px 8px !important;padding-left:20px}
            #paymentPage li{font-size:.88em;line-height:1.6}

            .till-num{font-size:2em}
            .amount-text{font-size:1.35em}
        }

        @media (max-width:380px){
            .container{padding:8px}
            .card,.founder-card{padding:12px}
            .subj-row{grid-template-columns:minmax(0,1fr) 76px}
            select{font-size:12px;padding:9px 6px}
            .header h1{font-size:1.2em}
            .pts-big{font-size:2.35em}
            #landingPage,#paymentPage{padding:7px !important}
            #landingPage>div,#paymentPage>div{padding:14px !important}
            #paymentPage li{font-size:.82em}
        }
